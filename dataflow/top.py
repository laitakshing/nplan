            ...
            if (not self._args and not self._kwargs and
                ...
                if self._reverse:
                    if compare is None or compare is operator.lt:
                        ...
                        def compare(a, b): return original_compare(b, a)
    ...
    class PerKey(ptransform.PTransform):
        ...
        def expand(self, pcoll):
            ...
            return pcoll | core.CombinePerKey(
                TopDistinctFn(self._n, self._compare,
                              self._key, self._reverse),
                *self._args, **self._kwargs)
...
class TopDistinctFn(core.CombineFn):
    ...
    def merge_accumulators(self, accumulators, *args, **kwargs):
        if args or kwargs:
            ...
            def add_input(accumulator, element): return self.add_input(
